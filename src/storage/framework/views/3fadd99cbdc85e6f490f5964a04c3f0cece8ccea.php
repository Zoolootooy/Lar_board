        ...
        <div class="col-12">
            <div class="bg-white p-2 mb-4 rounded">
                <div class="row">
                    ...
                    <form method="POST" action="<?php echo e(route('saveNew')); ?>"  enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row">
...
<?php echo $__env->make('header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\WEB\lar_board\src\resources\views/new.blade.php ENDPATH**/ ?>